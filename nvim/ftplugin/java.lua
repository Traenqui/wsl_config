...
local config = {
	...
	settings = {
		java = {
			...
			home = "/home/traenqui/.local/share/mise/installs/java/openjdk-19",
			eclipse = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-19",
						path = "/home/traenqui/.local/share/mise/installs/java/openjdk-19",
					},
				},
			},
			project = {
				referencedLibraries = {
					"/mnt/c/repos/study/algorithmen-und-datenstrukturen/1-search-trees/exercise/lib/junit-platform-console-standalone-1.11.0.jar",
				},
			},
			maven = {
				downloadSources = true,
